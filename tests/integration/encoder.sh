...
test_encoder 'test_map_variants(MyMap({["foo"] = "boo"}))'
...
test_encoder 'test_option_record({x = 42, y = None})'
test_encoder 'test_address_record({account = ak_2kE1RxHzsRE4LxDFu6WKi35BwPvrEawBjNtV788Gje3yqADvwR, amount = 42})'
