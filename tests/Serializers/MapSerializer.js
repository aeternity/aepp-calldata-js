...
test('Serialize', (t) => {
    ...
    t.deepEqual(
        s.serialize(
            new FateMap(FTInt, FateTypeMap(FTInt, FTBool), [
                [
                    new FateInt(0),
...
test('Deserialize', (t) => {
    ...
    t.deepEqual(
        ...
        new FateMap(FTInt, FateTypeMap(FTInt, FTBool), [
            [new FateInt(0), new FateMap(FTInt, FTBool, [[new FateInt(0), new FateBool(false)]])],
            [new FateInt(1), new FateMap(FTInt, FTBool, [[new FateInt(1), new FateBool(true)]])],
            [new FateInt(2), new FateMap(FTInt, FTBool, [[new FateInt(8), new FateBool(true)]])],
        ]),
        'nested map'
    )
