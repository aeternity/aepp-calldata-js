...
test('Serialize', (t) => {
    ...
    t.deepEqual(
        s.serialize(new FateTuple([FTInt], [new FateInt(0)])),
        [27, 0],
    ...
    const t1 = new FateTuple([FTBool, FTInt], [new FateBool(false), new FateInt(0)])
    const t2 = new FateTuple([FTBool, FTInt], [new FateBool(true), new FateInt(1)])

    t.deepEqual(
        s.serialize(new FateTuple([t1.type, t2.type], [t1, t2])),
...
test('Deserialize', (t) => {
    ...
    t.deepEqual(
        ...
        new FateTuple([t1.type, t2.type], [t1, t2]),
        'nested tuple'
    )
})
