...
import {FateTypeInt, FateTypeTuple} from '../src/FateTypes.js'
...
test('Decode basic contract', t => {
    ...
    t.deepEqual(contract.bytecode.functions[1], {
        ...
        instructions: [[{mnemonic: 'RETURNR', args: [{mod: 'immediate', arg: 2n}]}]],
    })
})
