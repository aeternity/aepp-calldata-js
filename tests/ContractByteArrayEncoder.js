...
test('Encode primitives', t => {
    ...
    t.is(
        encoder.encode(FateTypeBytes(32), new Uint8Array([0xbe, 0xef])),
        'cb_nwEJvu+rlRrs',
        'bytes'
    )
...
test('Encode composite types', t => {
    ...
    t.deepEqual(encoder.encode(FateTypeVariant(variants), {No: []}), 'cb_r4QAAAEAAT8xtJ9f')
})
...
test('Decode composite types', t => {
    ...
    t.deepEqual(
        encoder.decode('cb_r4QAAAEAAT8xtJ9f'),
        {1: []},
