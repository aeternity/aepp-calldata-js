...
test('Serialize all types', t => {
    ...
    t.deepEqual(ser(t, new FateVariant([0, 0, 1, 0], 1)), [175, 132, 0, 0, 1, 0, 1, 63])

    // bytes and objects serializers
    t.deepEqual(ser(t, new FateBytes(0xbeef)), [159, 1, 9, 190, 239])
    t.deepEqual(
        ser(
            t,
            new FateAccountAddress(
                '0xfedcba9876543210fedcba9876543210fedcba9876543210fedcba9876543210'
            )
        ),
        [
            159, 0, 160, 254, 220, 186, 152, 118, 84, 50, 16, 254, 220, 186, 152, 118, 84, 50, 16,
    ...
    t.deepEqual(
        ser(
            t,
            new FateContractAddress(
                '0xfedcba9876543210fedcba9876543210fedcba9876543210fedcba9876543210'
            )
        ),
        [
            159, 2, 160, 254, 220, 186, 152, 118, 84, 50, 16, 254, 220, 186, 152, 118, 84, 50, 16,
            254, 220, 186, 152, 118, 84, 50, 16, 254, 220, 186, 152, 118, 84, 50, 16,
        ]
    )
    t.deepEqual(
    ...
    t.deepEqual(
        ser(
            t,
            new FateChannelAddress(
                '0xfedcba9876543210fedcba9876543210fedcba9876543210fedcba9876543210'
            )
        ),
        [
            159, 5, 160, 254, 220, 186, 152, 118, 84, 50, 16, 254, 220, 186, 152, 118, 84, 50, 16,
            254, 220, 186, 152, 118, 84, 50, 16, 254, 220, 186, 152, 118, 84, 50, 16,
        ]
    )
})
...
test('Deserialize all types', t => {
    ...
    t.deepEqual(
        deser(
            t,
            [
                159, 0, 160, 254, 220, 186, 152, 118, 84, 50, 16, 254, 220, 186, 152, 118, 84, 50,
                16, 254, 220, 186, 152, 118, 84, 50, 16, 254, 220, 186, 152, 118, 84, 50, 16,
            ]
        ),
    ...
    t.deepEqual(
        deser(
            t,
            [
                159, 2, 160, 254, 220, 186, 152, 118, 84, 50, 16, 254, 220, 186, 152, 118, 84, 50,
                16, 254, 220, 186, 152, 118, 84, 50, 16, 254, 220, 186, 152, 118, 84, 50, 16,
            ]
        ),
        new FateContractAddress(
    ...
    t.deepEqual(
        deser(
            t,
            [
                159, 3, 160, 254, 220, 186, 152, 118, 84, 50, 16, 254, 220, 186, 152, 118, 84, 50,
                16, 254, 220, 186, 152, 118, 84, 50, 16, 254, 220, 186, 152, 118, 84, 50, 16,
            ]
        ),
    ...
    t.deepEqual(
        deser(
            t,
            [
                159, 4, 160, 254, 220, 186, 152, 118, 84, 50, 16, 254, 220, 186, 152, 118, 84, 50,
                16, 254, 220, 186, 152, 118, 84, 50, 16, 254, 220, 186, 152, 118, 84, 50, 16,
            ]
        ),
        new FateOracleQueryAddress(
    ...
    t.deepEqual(
        deser(
            t,
            [
                159, 5, 160, 254, 220, 186, 152, 118, 84, 50, 16, 254, 220, 186, 152, 118, 84, 50,
                16, 254, 220, 186, 152, 118, 84, 50, 16, 254, 220, 186, 152, 118, 84, 50, 16,
            ]
        ),
...
test('Serialize errors', t => {
    ...
    t.throws(() => serializer.serialize('invalid data'), {name: 'SerializerError'})

    t.throws(() => serializer.serialize({invalid: 'data'}), {name: 'SerializerError'})

    t.throws(() => serializer.serialize(new FateData('invalid type')), {name: 'SerializerError'})
})

test('Deserialize errors', t => {
    t.plan(4)

    t.throws(() => serializer.deserialize('invalid data'), {name: 'SerializerError'})

    t.throws(() => serializer.deserialize('invalid data'), {name: 'SerializerError'})

    t.throws(() => serializer.deserialize(new FateData('invalid type')), {name: 'SerializerError'})

    t.throws(() => serializer.deserializeStream('invalid data'), {name: 'SerializerError'})
})
